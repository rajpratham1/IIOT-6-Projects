...
# Custom static file handler for sub-applications
@app.route('/<app_name>/static/<path:filename>')
def sub_app_static(app_name, filename):
    return send_from_directory(f'static/{app_name}', filename)
